...
- **Title tag:** Free Late Rent Notice Template and Pay or Quit Generator | Advanced Collection Bureau
...
1. **H1:** Late Rent Notice Generator
...
(function(){
  ...
  f.src='https://noahalbers.github.io/acb-tools/tools/late-rent-notice-generator/'+(location.hash||'');
...
- **H3: Can I include late fees in the notice?** Only fees your lease actually authorizes, and within any state cap. Some states also limit whether a pay-or-quit notice can demand fees on top of rent, so when in doubt, demand the rent and bill the fees separately. The generator itemizes each charge so the total is transparent.
    ...
    },
    {
      ...
      "mainEntity": [
        ...
        {"@type": "Question", "name": "What if the tenant pays part of the balance?",
         "acceptedAnswer": {"@type": "Answer", "text": "Be careful: in some states accepting partial payment after serving a pay-or-quit notice waives the notice and you must re-serve. The generated formal notice includes a reservation-of-rights paragraph, but check your state's rule before taking partial payment, and log it as a payment-received credit if you re-issue."}},
