...
> paste the single iframe embed below in their place. Existing share links keep working —
> the iframe snippet forwards the page's hash into the tool, and the tool still reads the
> legacy `#d=` link format.

## Page settings (Webflow → Page Settings)

- **Title tag:** Free Move-In / Move-Out Checklist — Rental Inspection Checklist Creator | Advanced Collection Bureau
...
1. **H1:** Free Move-In / Move-Out Checklist Creator
